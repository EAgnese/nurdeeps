...
ALTER TABLE GAME_TYPES ADD FOREIGN KEY (game_code) REFERENCES GAMES (game_code);
ALTER TABLE SUGGESTIONS ADD FOREIGN KEY (user_id) REFERENCES USERS (user_id);
ALTER TABLE CONTAINS_RUNS ADD FOREIGN KEY (game_code) REFERENCES GAMES (game_code);
ALTER TABLE CONTAINS_RUNS ADD FOREIGN KEY (run_category_code) REFERENCES RUN_CATEGORIES (run_category_code);